...
public class ModelOutputReader : IDataProvider<ModelOutput>
{
    ...
    public ModelOutputReader(IInstructionFilesProvider insFilesProvider, IExperimentProvider experimentsProvider, IPathResolver resolver)
    {
    ...
    public async Task<IEnumerable<SeriesData>> ReadAsync(ModelOutput source, CancellationToken ct)
    {
        ...
        IEnumerable<string> instructionFiles = GetInstructionFiles(source);
    ...
    /// <summary>
    /// Get the instruction files to be read for the given model output.
    /// </summary>
    /// <param name="source">The model output.</param>
    /// <returns>The instruction files to be read.</returns>
    private IEnumerable<string> GetInstructionFiles(ModelOutput source)
    {
        // Get all instruction files generated by experiments.
        ...
        foreach (string insFile in source.InstructionFiles)
        {
